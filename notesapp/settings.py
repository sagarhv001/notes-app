...
# Jazzmin Settings
JAZZMIN_SETTINGS = {
    "site_title": "Notes App Admin",
    "site_header": "Notes App",
    "site_brand": "Notes App",
    "welcome_sign": "Welcome to the Notes App Admin",
    "copyright": "Notes App Ltd",
    "search_model": ["auth.User", "notes.Note", "tasks.Task"],
    "user_avatar": None,
    "topmenu_links": [
